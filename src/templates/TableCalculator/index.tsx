...
import CalcRow, { EditFormula } from "../../organisms/CalcRow";
import { Formula } from "../../types/state";
import { calcFormula } from "../../libs/Util";
import RecordRow from "../../organisms/RecordRow";
...
const TableCalculator: React.FC<AppProps> = (props: AppProps) => {
  let total = 0;
